...
`,F4=()=>{const[e,t]=E.useState(!1),n=()=>{t(!0),document.body.classList.add("no-scroll")},r=()=>{t(!1),document.body.classList.remove("no-scroll")};return m.jsxs(M4,{children:[e?m.jsx(bp,{onClick:r,src:L4,alt:"mobile menu close"}):m.jsx(bp,{onClick:n,src:z4,alt:"mobile menu"}),e?m.jsx(D4,{children:m.jsx(y1,{closeMobileMenu:r})}):null]})},U4=()=>{const[e,t]=E.useState(!1);return E.useEffect(()=>{const n=()=>{};return window.addEventListener("scroll",n),()=>{window.removeEventListener("scroll",n)}},[]),E.useEffect(()=>{const n=()=>{window.innerWidth<778?t(!0):t(!1)};return n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}},[]),m.jsxs(kw,{children:[m.jsxs(Sw,{children:[m.jsx(Cw,{to:"/",end:!0,children:m.jsxs(bw,{children:[m.jsxs(bu.Provider,{value:{color:"#ff4d4d",size:"1.5em",className:"global-class-name"},children:[m.jsx("span",{role:"img","aria-label":"music icon",children:m.jsx(_w,{})}),""]}),"КДМШ №22"]})}),e?m.jsx(m.Fragment,{children:m.jsx(F4,{})}):m.jsxs("nav",{children:[m.jsx(Zr,{to:"/",end:!0,children:"Головна"}),m.jsx(Zr,{to:"/about",children:"Про нас"}),m.jsx(Zr,{to:"/departments",children:"Відділи"}),m.jsx(Zr,{to:"/bands",children:"Колективи"}),m.jsx(Zr,{to:"/contacts",children:"Контакти"})]})]}),m.jsx(h0,{}),m.jsx(R4,{})]})},B4=D.div`
  position: relative;
  display: flex;
...
font-size: 12px;
line-height: 1.1;
`,r5=()=>m.jsx(k1,{children:m.jsxs(Z4,{children:[m.jsx(w1,{data:X4}),m.jsx(e5,{children:m.jsx("svg",{children:m.jsx("text",{x:"2%",y:"50%",dy:".15em",children:"Ласкаво просимо у світ музики!"})})})]})}),i5=O.div`
/* position: relative;
display: flex;
flex-direction:column; */

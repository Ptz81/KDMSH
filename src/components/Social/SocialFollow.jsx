...
export const SocialFollow = () => {
    return (
      ...
      <Link aria-label="youtube link" to="https://www.youtube.com/@user-ck5dw5yi1l/videos"
        className="youtube social" target = "_blank">
        <FontAwesomeIcon style={{ color: '#eb3223', marginRight: "20px"}} icon={faYoutube} size="2x" />
      </Link>
      <Link aria-label="facebook link"  to="https://www.facebook.com/kdmsh22"
      ...
      <Link aria-label="instagram link"  to="https://www.instagram.com/kdmsh22/"

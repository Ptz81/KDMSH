...
`,s5=j.div`
  color: var(--subColor);
  font-size: 17px;
`,z1=({options:e,value:t,onChange:n,placeholder:r,onFilterChange:i})=>{const[o,a]=C.useState(!1),[l,s]=C.useState(t||""),u=p=>{p!==l&&(s(p),n(p),i(p)),a(!1)},f=()=>{a(!o)};return d.jsxs(i5,{onClick:f,children:[d.jsx(o5,{children:r?l||d.jsx(s5,{children:r}):l}),o?d.jsx(r5,{width:20,height:20,style:{position:"absolute",top:"20px",right:"20px"}}):d.jsx(n5,{style:{position:"absolute",top:"20px",right:"20px"}}),o&&d.jsx(a5,{open:o,children:e.map(p=>d.jsx(l5,{onClick:()=>u(p),children:p},p))})]})};z1.propTypes={options:_.arrayOf(_.string),value:_.string,onChange:_.func,placeholder:_.string,onFilterChange:_.func};const u5=j.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,k5=()=>{const{id:e}=p0(),t=m5(e),n=Sl(),r=()=>{n(-1)};return d.jsxs(G1,{children:[d.jsxs(x5,{children:[d.jsx(w5,{src:t.photo,alt:t.name,onError:i=>{i.target.style.display="none";const o=document.createElement("div");o.style.width="100%",o.style.height="200px",o.style.border="1px solid var(--accentColor)",o.style.backgroundColor="linear-gradient(to right, #fff5ed 0 90%)",i.target.parentNode.insertBefore(o,i.target)}}),d.jsx(H1,{children:t.name}),d.jsx(Y1,{children:t.about}),d.jsx(Q1,{children:d.jsx(K1,{})})]}),d.jsx(so,{"aria-label":"go back",onClick:r,children:"Повернутися назад"})]})},b5=j.div`
margin: auto;
min-height: 700px;
`,S5=j.h2`
...
color: var(--accentColor);
`,j5="/KDMSH/assets/map-a7958fcf.png",_5=()=>d.jsxs(b5,{children:[d.jsx(S5,{children:"Контактна інформація"}),d.jsxs(C5,{children:[d.jsx(d.Fragment,{children:d.jsx(E5,{src:j5,alt:"map",width:"500px",height:"500px"})}),d.jsx(P5,{children:d.jsxs("ul",{children:[d.jsxs("li",{children:[d.jsx(Uo,{children:"Адреса:"})," вулиця Зодчих, 30а, ",d.jsx("br",{}),"Київ, 03194"]}),d.jsxs("li",{children:[d.jsx(Uo,{children:"Телефон:"}),d.jsx(At,{to:"tel:+380934139512",style:{textDecoration:"none",color:"#212121"},children:"(093) 413-95-12"})]}),d.jsxs("li",{children:[d.jsx(Uo,{children:"Email:"}),d.jsx(At,{to:"mailto:dmsh22@ukr.net",target:"_blank",style:{textDecoration:"none",color:"#212121"},children:"dmsh22@ukr.net"})]}),d.jsxs("li",{children:[d.jsx(Uo,{children:"Розклад роботи:"})," ",d.jsx("br",{})," пн-пт: 10.00 - 20.00 ",d.jsx("br",{})," cб: 10.00 - 16.00 ",d.jsx("br",{})," нд: вихідний"]})]})})]})]}),T5=()=>d.jsx(lo,{children:d.jsxs(Mr,{children:[d.jsx(Ir,{children:"Про нас"}),"Для мешканців Святошинського району працює з 1971 року. Школа є державним позашкільним навчальним закладом освіти в галузі культури, здійснює естетичне виховання дітей, учнів, громадян, забезпечуючи принцип єдності і наступності мистецької освіти; проводить навчально-виховну, методичну, просвітницьку роботу."]})}),N5=()=>d.jsx(C.Suspense,{fallback:d.jsx($x,{}),children:d.jsx(k2,{children:d.jsxs(We,{path:"/",element:d.jsx(rb,{}),children:[d.jsx(We,{index:!0,element:d.jsx(wb,{})}),d.jsx(We,{path:"about",element:d.jsx(kb,{})}),d.jsx(We,{path:"school",element:d.jsx(T5,{})}),d.jsx(We,{path:"management",element:d.jsx($b,{})}),d.jsx(We,{path:"team/:currentPage",element:d.jsx(L1,{})}),d.jsx(We,{path:"reviews",element:d.jsx(c5,{})}),d.jsx(We,{path:"departments",element:d.jsx(h5,{})}),d.jsx(We,{path:"departments/:id",element:d.jsx(v5,{})}),d.jsx(We,{path:"bands",element:d.jsx(y5,{})}),d.jsx(We,{path:"bands/:id",element:d.jsx(k5,{})}),d.jsx(We,{path:"contacts",element:d.jsx(_5,{})})]})})});function O5(){return d.jsx(d.Fragment,{children:d.jsx(N5,{})})}ks.createRoot(document.getElementById("root")).render(d.jsx(_2,{basename:"/KDMSH",children:d.jsx(O5,{})}));

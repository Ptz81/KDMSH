...
`;const M4=()=>m.jsxs(I4,{children:[m.jsx(L4,{children:"Слідкуйте за нами у соцмережах"}),m.jsx(zt,{"aria-label":"youtube link",to:"https://www.youtube.com/@user-ck5dw5yi1l/videos",className:"youtube social",target:"_blank",children:m.jsx(Fn,{style:{color:"#eb3223",marginRight:"20px"},icon:R4,size:"2x"})}),m.jsx(zt,{"aria-label":"facebook link",to:"https://www.facebook.com/kdmsh22",className:"facebook social",target:"_blank",children:m.jsx(Fn,{style:{color:"#4968ad",backgroundColor:"#fff",borderRadius:"50%",marginRight:"20px"},icon:z4,size:"2x"})}),m.jsx(zt,{"aria-label":"instagram link",to:"https://www.instagram.com/kdmsh22/",className:"instagram social",target:"_blank",children:m.jsx(Fn,{style:{color:"#ff4d4d"},icon:A4,size:"2x"})})]}),D4=j.footer`
    position: relative;
     ${""}
  color: var(--accentColor);
...
`,S1=({isOpen:e,closeModal:t,children:n})=>{const r=a=>{a.stopPropagation()},i=a=>{a.target===a.currentTarget&&t()};return E.useEffect(()=>{e?(document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden"):(document.body.style.overflow="auto",document.documentElement.style.overflow="auto")},[e]),m.jsx(m.Fragment,{children:e&&m.jsx($5,{onClick:i,children:m.jsxs(A5,{className:"ModalContent",onClick:r,children:[m.jsx(z5,{onClick:t,children:m.jsx(O5,{size:18})}),n]})})})};S1.propTypes={isOpen:T.bool.isRequired,closeModal:T.func.isRequired,children:T.node};const R5=D.div`
font-size: inherit;
@media screen and (min-width: 768px) {
margin-bottom:20px;
margin-top:20px
...
`,ib=()=>{const{id:e}=c0(),t=Z5(e),n=kl(),r=()=>{n(-1)};return m.jsxs(F1,{children:[m.jsxs(nb,{children:[m.jsx(rb,{src:t.photo,alt:t.name,onError:i=>{i.target.style.display="none";const a=document.createElement("div");a.style.width="100%",a.style.height="200px",a.style.border="1px solid var(--accentColor)",a.style.backgroundColor="linear-gradient(to right, #fff5ed 0 90%)",i.target.parentNode.insertBefore(a,i.target)}}),m.jsx(M1,{children:t.name}),m.jsx(D1,{children:t.about}),m.jsx(U1,{children:m.jsx(B1,{})})]}),m.jsx($l,{"aria-label":"go back",onClick:r,children:"Повернутися назад"})]})},ab=j.div`
margin: auto;
min-height: 700px;
`,ob=j.h2`
...
color: var(--accentColor);
`,cb="/KDMSH/assets/map-a7958fcf.png",fb=()=>m.jsxs(ab,{children:[m.jsx(ob,{children:"Контактна інформація"}),m.jsxs(lb,{children:[m.jsx(m.Fragment,{children:m.jsx(sb,{src:cb,alt:"map",width:"500px",height:"500px"})}),m.jsx(ub,{children:m.jsxs("ul",{children:[m.jsxs("li",{children:[m.jsx(Ma,{children:"Адреса:"})," вулиця Зодчих, 30а, ",m.jsx("br",{}),"Київ, 03194"]}),m.jsxs("li",{children:[m.jsx(Ma,{children:"Телефон:"}),m.jsx(zt,{to:"tel:+380934139512",style:{textDecoration:"none",color:"#212121"},children:"(093) 413-95-12"})]}),m.jsxs("li",{children:[m.jsx(Ma,{children:"Email:"}),m.jsx(zt,{to:"mailto:dmsh22@ukr.net",target:"_blank",style:{textDecoration:"none",color:"#212121"},children:"dmsh22@ukr.net"})]}),m.jsxs("li",{children:[m.jsx(Ma,{children:"Розклад роботи:"})," ",m.jsx("br",{})," пн-пт: 10.00 - 20.00 ",m.jsx("br",{})," cб: 10.00 - 16.00 ",m.jsx("br",{})," нд: вихідний"]})]})})]})]}),db=()=>m.jsx(oa,{children:m.jsxs(Yi,{children:[m.jsx(Lr,{children:"Про нас"}),"Для мешканців Святошинського району працює з 1971 року. Школа є державним позашкільним навчальним закладом освіти в галузі культури, здійснює естетичне виховання дітей, учнів, громадян, забезпечуючи принцип єдності і наступності мистецької освіти; проводить навчально-виховну, методичну, просвітницьку роботу."]})}),pb=()=>m.jsx(E.Suspense,{fallback:m.jsx(E2,{}),children:m.jsx(mx,{children:m.jsxs(We,{path:"/",element:m.jsx(X4,{}),children:[m.jsx(We,{index:!0,element:m.jsx(p5,{})}),m.jsx(We,{path:"about",element:m.jsx(m5,{})}),m.jsx(We,{path:"school",element:m.jsx(db,{})}),m.jsx(We,{path:"management",element:m.jsx(E5,{})}),m.jsx(We,{path:"team/:currentPage",element:m.jsx(Y5,{})}),m.jsx(We,{path:"reviews",element:m.jsx(G5,{})}),m.jsx(We,{path:"departments",element:m.jsx(q5,{})}),m.jsx(We,{path:"departments/:id",element:m.jsx(eb,{})}),m.jsx(We,{path:"bands",element:m.jsx(tb,{})}),m.jsx(We,{path:"bands/:id",element:m.jsx(ib,{})}),m.jsx(We,{path:"contacts",element:m.jsx(fb,{})})]})})});function mb(){return m.jsx(m.Fragment,{children:m.jsx(pb,{})})}ws.createRoot(document.getElementById("root")).render(m.jsx(kx,{basename:"/KDMSH",children:m.jsx(mb,{})}));
